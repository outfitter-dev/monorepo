...
const deleteOldCacheMock = deleteOldCache as MockedFunction<
  typeof deleteOldCache
>;
...
describe('/internal Routes', () => {
  ...
  describe('/internal/delete-old-cache route', () => {
    ...
    test('should invoke the deleteOldCache method', async () => {
      const request = new Request(
        'http://localhost/internal/delete-expired-objects',
        {
          method: 'POST',
          headers: {
  ...
  describe('/internal/populate-random-objects route', () => {
    ...
    test('should successfully add random objects to R2', async () => {
      const request = new Request(
        'http://localhost/internal/populate-random-objects',
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
